...
- Added `archaudit` criterion.

### Changed

- Improved default update provider guessing by parsing `ID` and `ID_LIKE` from `/etc/os-release` with fallback to `/etc/system-release`. Previously it always tried to pick `pacman` regardless of distro.
...
- Added `--list-criteria` flag to `check` command for easier setup/debugging.
...
[unreleased]: https://github.com/t4k1t/siun/compare/v2.2.0...HEAD
[2.2.0]: https://github.com/t4k1t/siun/compare/2.1.0...2.2.0
[2.1.0]: https://github.com/t4k1t/siun/compare/2.0.1...2.1.0
